        ...
        <table class="w-full text-sm text-left text-gray-500">
            <thead class="text-sm text-gray-900 uppercase bg-gray-50">
                <tr>
                    ...
                    <th scope="col" id="open-modal" class="px-6 py-5 pop" onclick="openPopup()" style="float: right">
...
content.innerHTML = '<form method="post" action="admin_student_add.php">' +
                    '<label for="name">Student Name:</label>' +
                    '<input type="text" id="username" name="username"><br>' +
                    '<label for="name">KBTUG ID:</label>' +
                    '<input type="text" id="kbtugid" name="kbtugid"><br>' +
...
<script>
  ...
  function saveInput() {
    ...
    alert(input + " added to Student List");
    closePopup();
  }
